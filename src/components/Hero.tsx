...
export const Hero = () => {
  ...
  return <div className="relative h-screen bg-black flex items-center justify-center">
      ...
      <button onClick={scrollToContent} className="absolute bottom-12 left-1/2 transform -translate-x-1/2 text-white/50 hover:text-white transition-colors duration-300">
